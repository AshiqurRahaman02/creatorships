...
const SignIn = () => {
	...
	const handleSignInSubmit = async (e: React.FormEvent) => {
		e.preventDefault();
		if (!email || !password) {
			notify("Please enter a valid email and password", "warning");
			return;
		}
		setLoading(true);
		try {
...
<div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-gray-400  rounded-lg">
			<form className="form" onSubmit={handleSignInSubmit}>
				...
				<p className="p">
					...
					<span className="span" onClick={() => router.push("/register")}>
						Sign Up
					</span>
				</p>
